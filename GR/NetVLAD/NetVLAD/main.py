...
parser.add_argument('--dataset', type=str, default='berlin', 
        help='Dataset to use', choices=['small_2','spair_90', 'spair_180','SMALL','TOPVIEW','PERSPECTIVE','sT4fr6TAbpF','pittsburgh','oxford','darkzurich','nordland','tokyo247','berlin','gardens_point','tb_places'])
...
def test(eval_set, save_path, epoch=0):
    ...
    if opt.save:
      ...
      np.save(join(save_path, 'netvlad_dist.npy'), distances)

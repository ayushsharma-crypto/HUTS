...
def getPerspKeypoints(rgbFile1, rgbFile2, HFile1, HFile2, model, device):
	...
	match_quality = {
		"rgb1":rgbFile1,
		"rgb2":rgbFile2,
		"inliers": len(placeholder_matches),
		"inlier_keypoints_left": orgSrc,
		"inlier_keypoints_right": orgDst,
		"ortho_desp1": feat1["descriptors"][matches[:, 0], : ][inliers],
		"ortho_desp2": feat2["descriptors"][matches[:, 1], : ][inliers]
	}
	return orgSrc, orgDst, matchImg, image3, match_quality
